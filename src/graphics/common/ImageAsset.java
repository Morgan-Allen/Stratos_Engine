...
public class ImageAsset extends Assets.Loadable {
  ...
  protected Pixmap  pixels  ;
  protected Texture texture ;
  protected Colour  average ;
  
  
  protected ImageAsset(Class sourceClass, String ID, String filePath) {
  ...
  public java.awt.Color colourTint() {
    average();
    return new java.awt.Color(average.r, average.g, average.b, 1);
  }
  
  
  public int pixelWide() {
    return texture.getWidth();
  }
  
  
  public int pixelHigh() {
  ...
  protected static Colour extractAverage(Pixmap pixels) {
    Colour average = new Colour();
  ...
  public static ImageAsset withColor(final int size, Colour c, Class source) {
    ...
    final ImageAsset asset = new ImageAsset(source, c+"_img", "IMAGE_ASSET_"+c) {
      protected State loadAsset() {
