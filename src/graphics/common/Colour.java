...
public class Colour {
  ...
  final public static Colour FOG_VALS[]       = new Colour[100];
  static {
    for (int n = 100; n-- > 0;) {
      final float l = n / 100f;
      final Colour t = TRANSPARENCIES[n] = new Colour();
      t.set(1, 1, 1, l);
      final Colour s = GREYSCALES[n] = new Colour();
      s.set(l, l, l, 1);
      final Colour g = GLOWS[n] = new Colour();
      g.set(1, 1, 1, -l);
      final Colour f = FOG_VALS[n] = new Colour();
      f.set(0, 0, 0, l);
    }
  }
  ...
  public static Colour fogVal(float a) {
    return FOG_VALS[Nums.clamp((int) (a * 100), 100)];
  }
